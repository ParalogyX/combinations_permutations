...
for i in range(1,5):
    print(i)
    if tst in (1,3): digitCode.SetTypeOfCombination(i)
    if tst in (2,3): stringCode.SetTypeOfCombination(i)
    if tst in (1,3): print("Digital code type:", digitCode.GetTypeOfCombination())
    if tst in (2,3): print("String code type:", stringCode.GetTypeOfCombination())
    if tst in (1,3):
